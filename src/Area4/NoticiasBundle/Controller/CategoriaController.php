...
use Area4\NoticiasBundle\Entity\Categoria;
use Area4\NoticiasBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('Area4NoticiasBundle:Categoria')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('Area4NoticiasBundle:Categoria')->find($id);
     ...
     * @Method("post")
     * @Template("Area4NoticiasBundle:Categoria:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("Area4NoticiasBundle:Categoria:edit.html.twig")
     */
